  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box className="w-[550px]  bg-white p-6 rounded-md shadow-md absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <Typography variant="h6" className="mb-4 text-center text-2xl font-bold">Edit Todo</Typography>
        <TextField
          fullWidth
          value={editedText}
        ...
        <Box className="flex justify-evenly mt-4">
          <Button onClick={onClose} className="mr-2" variant="outlined">Cancel</Button>
