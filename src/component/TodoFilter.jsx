  ...
  >
    ...
    <ButtonGroup fullWidth className="mb-4 mt-4">
      <Button 
        ...
        sx={filter === 'all' ? { backgroundColor: 'rgb(20, 184, 166)', '&:hover': { backgroundColor: 'rgb(13, 148, 136)' } } : {}}
      >
        All
      </Button>
      <Button 
        ...
        sx={filter === 'done' ? { backgroundColor: 'rgb(20, 184, 166)', '&:hover': { backgroundColor: 'rgb(13, 148, 136)' } } : {}}
      >
        Done
      </Button>
      <Button 
        ...
        sx={filter === 'todo' ? { backgroundColor: 'rgb(20, 184, 166)', '&:hover': { backgroundColor: 'rgb(13, 148, 136)' } } : {}}
      >
        Todo
      </Button>
    </ButtonGroup>
